...
class Deatil extends Component{
      ...
      componentWillMount(){
        ...
        return ( 
          <div id="content">
          <Header  head="职位详情"/>
          <span id="back" onClick={this.handleBack}>返回</span>
        ...
        <div className="company activeable" data-lg-tj-id="19v6" data-lg-tj-no="0030" data-lg-tj-cid="50702">
            <img src={"https://static.lagou.com/"+companyLogo} className="logo" />
            <div className="desc">
                <div className="dleft">
        ...
        <button id="button_bottom">投递简历</button>
      </div>)
   	  }
      handleBack(){
